    ...
    <div class="col-sm-10 col-md-6 px-sm-0 align-self-center mx-auto py-5">
        <div class="row justify-content-center g-0">
          <div class="col-lg-9 col-xl-8 col-xxl-6">
            <div class="card">
              <div class="card-header bg-circle-shape bg-shape text-center p-2"><a class="font-sans-serif fw-bolder fs-4 z-index-1 position-relative link-light light" href="#">Finca Regalo de Dios</a></div>
            ...
            @endif
                <form method="POST" action="{{ route('login') }}">
                  ...
                  <div class="mb-3">
                    ...
                    <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" id="split-login-email" type="email"  name="email" :value="old('email')" required />
                  </div>
                  <div class="mb-3">
