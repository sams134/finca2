          ...
          <div class="row">
            <div class="col-lg-8 mb-4 mb-lg-0">
              <div class="product-slider" id="galleryTop">
                ...
                <div class="swiper-container theme-slider position-lg-absolute all-0" data-swiper='{"autoHeight":false,"spaceBetween":5,"loop":true,"loopedSlides":5,"thumb":{"spaceBetween":5,"slidesPerView":5,"loop":true,"freeMode":true,"grabCursor":true,"loopedSlides":5,"centeredSlides":true,"slideToClickedSlide":true,"watchSlidesVisibility":true,"watchSlidesProgress":true,"parent":"#galleryTop"},"slideToClickedSlide":true}'>
                  <div class="swiper-wrapper h-100">
                          @foreach ($animal->images as $image)
                            <div class="swiper-slide h-100"><img class="rounded-1 fit-cover h-100 w-100" src="{{asset('storage/animals/'.$image->url)}}" alt="" /></div>
                          @endforeach
            ...
            <div class="col-lg-4">
              <h5>{{$animal->type->name}} #{{$animal->number}}</h5>
              <div class="mb-4">
              ...
              @if ($animal->cost)
              <h4 class="d-flex align-items-center">Costo:<span class="text-warning me-2 ms-2"> Q.{{$animal->cost}}</span><span class="me-1 fs--1 text-500"> </span></h4>
              @endif
              ...
              <div class="row">
                ...
                <div class="col-auto px-2 px-md-2"><a class="btn btn-sm btn-primary" href="#!"><span class="fas fa-cart-plus me-sm-2"></span><span class="d-none d-sm-inline-block">Vender</span></a></div>
