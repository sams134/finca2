      ...
      <div class="navbar-vertical-content scrollbar">
        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
          ...
          <li class="nav-item">
            ...
            <ul class="nav collapse show" id="forms">
              <li class="nav-item"><a class="nav-link dropdown-indicator" href="#basic" data-bs-toggle="collapse" aria-expanded="true" aria-controls="forms">
                  <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Basic</span>
                  </div>
                </a>
                <!-- more inner pages-->
                <ul class="nav collapse show" id="basic">
                  <li class="nav-item"><a class="nav-link active" href="../../../modules/forms/basic/form-control.html" aria-expanded="false">
        ...
        <div class="settings mb-3">
          <div class="card alert p-0 shadow-none" role="alert">
            ...
            <div class="card-body text-center"><img src="/img/icons/spot-illustrations/navbar-vertical.png" alt="" width="80" />
